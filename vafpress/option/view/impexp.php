<tr class="vp-textarea">
	<td class="label">
		<label>
			<?php _e('Import', 'vafpress') ?>
			<p class="description"><?php _e('Import Options', 'vafpress') ?></p>
		</label>
	</td>
	<td class="fields">
		<textarea id="vp-js-import_text"></textarea>
		<div class="buttons">
			<input id="vp-js-import" class="vp-button" type="button" value="<?php _e('Import', 'vafpress') ?>" />
...
<tr class="vp-textarea">
	<td class="label">
		<label>
			<?php _e('Export', 'vafpress') ?>
			<p class="description"><?php _e('Export Options', 'vafpress') ?></p>
		</label>
	</td>
	<td class="fields">
		<textarea id="vp-js-export_text" onclick="this.focus();this.select()" readonly="readonly"></textarea>
		<div class="buttons">
			<input id="vp-js-export" class="vp-button" type="button" value="<?php _e('Export', 'vafpress') ?>" />
			<span style="margin-left: 10px;">
